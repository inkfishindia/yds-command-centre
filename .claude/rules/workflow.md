...
6. **Follow file discipline** — See [`file-discipline.md`](file-discipline.md) for the contract on reading, editing, and refactoring: per-package FILE-MAP.md pre-flight, file-size ceilings, split methodology, lazy-require for mocked services, and the refactor contract (public API + behavior + tests frozen during mechanical splits).
