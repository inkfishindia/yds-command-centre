...
import { StrategicInitiativesPageProps, StrategicObjectivesPageProps, GoalsPageProps, QuarterlyInitiativesPageProps, ResourceAllocationBudgetPageProps, AllOrderItemsPageProps, OrderSummaryPageProps, PickListKanbanPageProps, ProductionScreenPageProps, OrderListProductsPageProps, DesignBoardPageProps, OrderDashboardPageProps } from './types';
...
const MainContentPage: React.FC<MainContentPageProps> = ({ 
    ...
    } else if (activeSubItemId === 'order_dashboard') { // NEW: For Order Dashboard
      Object.assign(componentProps, {
        title: activeSubItem?.label, // Pass title
      } as OrderDashboardPageProps);
    ...
    } else if (activeSubItemId === 'design_board') { // NEW: For Design Board Page
      Object.assign(componentProps, {
        title: activeSubItem?.label, // Pass title
